      ...
      <div className="relative w-full max-w-md animate-fade-in-up">
        <div className="overflow-hidden rounded-3xl border border-slate-100/80 bg-white/90 p-8 shadow-xl backdrop-blur-sm">
          <div className="mb-6 text-center">
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Create your venue</h1>
            <p className="mt-1 text-sm text-slate-500">Launch your digital menu, Wi-Fi gate, and review flow.</p>
          </div>
          <RegisterForm />
        </div>
      </div>
